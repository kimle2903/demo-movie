            ...
            <div class="col-5 footer-about">
                ...
                <ul class="list-footer-link">
                    <li class="item-footer-link">
                        <a href="" class="item-footer-href" title="android app">Android App </a>
                        <span class="space">-</span>
                    </li>
                    <li class="item-footer-link">
                        <a href="" class="item-footer-href" title="terms of service">Terms of service </a>
                        <span class="space">-</span>
                    </li>
                    <li class="item-footer-link">
                        <a href="" class="item-footer-href" title="contact"> Contact</a>
                        <span class="space">-</span>
                    </li>
                    <li class="item-footer-link">
                        <a href="" class="item-footer-href" title="sitemap"> Sitemap </a>
                    </li>
                </ul>
            </div>
            <div class="col-4 ">
